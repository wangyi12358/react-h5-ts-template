...
//用于支持webpack定义的别名 (需要安装 eslint-plugin-import 和 eslint-import-resolver-webpack 插件)
  ...
  "plugins": [
    "typescript",
    "babel", // 插件地址 https://github.com/babel/eslint-plugin-babel
...
//"no-console": "warn", // 代码禁止出现 console
     ...
     * import 规范
     */
    "import/first": 2, // import要放在文件顶部
    // "import/exports-last": 2, // exports要放在文件底部
    "import/order": [2, {"newlines-between": "never"}], // 绝对导入 放在 相对导入 之前
    ...
    // "typescript/quotemark": [0, "single", "avoid-escape", "jsx-double"],
    ...
    "typescript/object-literal-key-quotes": [0, "as-needed"],
    "typescript/no-trailing-whitespace": [0, "ignore-comments"],
    ...
    "react/jsx-indent-props": [2, 2], // 定义了 jsx component 没有使用
    ...
    "react/sort-comp": [1, { // createClass 属性的排序
      "order": [
        "defaultProps",
        "statics",
        "/Ref$/",
